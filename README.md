...
Você pode rodar o seguinte comando para subir todos os containers, lembrando que é necessário ter criado o arquivo .env primeiro e configurado todas as variáveis de ambiente.
